...
def run_reproducer_agent(*, workspace_dir: Path, command: str, trace: list[dict], sandbox: dict[str, Any] | None = None) -> dict:
    reproduction = run_command(command, workspace_dir, 20, DEFAULT_ALLOWED_PREFIXES, sandbox=sandbox)
